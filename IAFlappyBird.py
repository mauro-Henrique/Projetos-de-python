...
IMAGENS_PASSARO = [
    pygame.transform.scale2x(pygame.image.load(os.path.join('img', 'bird1 (1).png'))),
    pygame.transform.scale2x(pygame.image.load(os.path.join('img', 'bird2 (1).png'))),
...
def main(genomas, config): #fitness function
    ...
    while rodando:
        ...
        for i, passaro in enumerate(passaros):
            ...
            # -1 e 1 _> se o output for > 0.5 então o passaro pula
            if output[0] > 0.5:
                passaro.pular()
        chao.mover()
